...
<body class="corpo">
	...
	<!--<h1 class="texto"><i>Esses são os dados dos sensores!</i></h1>	-->
	<div>
		<table class="table table-striped">
			...
			<tbody class="corpogeral">
				...
				foreach ($dados as $value) {
					...
					if ($value['SENSORESSENSOR'] == 'temperatura')
						echo ('<td>' . $value['SENSORESVLR'] . ' °C</td>');
					else
						if ($value['SENSORESSENSOR'] == 'umidade')
						echo ('<td>' . $value['SENSORESVLR'] . ' - 3% UR</td>');
					else
						if ($value['SENSORESSENSOR'] == 'pressao')
						echo ('<td>' . $value['SENSORESVLR'] . ' hPA</td>');
